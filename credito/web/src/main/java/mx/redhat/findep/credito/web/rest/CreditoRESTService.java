...
//    		builder = Response.status(Response.Status.BAD_REQUEST).entity(responseObj);
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public Response startProcess(Solicitud solicitud)
    {
		Response.ResponseBuilder builder = null;
...
//    		validateSolicitud(solicitud);
    		...
    		solicitud = bpmService.startProcess(solicitud);
     ...
     * </p>
     * 
     * @param solicitud Member to be validated
     * @throws ConstraintViolationException If Bean Validation errors exist
     * @throws ValidationException If member with the same email already exists
     */
    private void validateSolicitud(Solicitud solicitud) throws ConstraintViolationException, ValidationException {
